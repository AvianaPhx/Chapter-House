      ...
      <nav className="mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex space-x-8 text-gray-700 font-medium">
            <NavItem icon={<Home className="w-5 h-5" />} label="Home" to="/home" />
            <NavItem icon={<BookOpen className="w-5 h-5" />} label="Books" to="/product" />
            <NavItem icon={<Bookmark className="w-5 h-5" />} label="Bookmark" to="/bookmarks" />
            <NavItem icon={<ShoppingCart className="w-5 h-5" />} label="Cart" to="/cart" />
            <NavItem icon={<ClipboardList className="w-5 h-5" />} label="Orders" to="/orderhistory" />
          </div>
